...
object UkrposhtaDeliveryService : DeliveryService {
    ...
    override suspend fun getParcel(
        ...
        val status = when (resp.last().event) {
            10100 -> Status.Preadvice
            20700, 20800, 21500 -> Status.InTransit
            21700, 21400 -> Status.InWarehouse
            31100, 31300, 31400 -> Status.DeliveryFailure
            41000, 48000 -> Status.Delivered
