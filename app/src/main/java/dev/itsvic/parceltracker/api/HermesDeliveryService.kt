...
object HermesDeliveryService : DeliveryService {
    ...
    override suspend fun getParcel(
        ...
        val status = when(resp.status.parcelStatus) {
    ...
    private val retrofit =
        Retrofit.Builder().baseUrl("https://api.my-deliveries.de/tnt/parcelservice/").client(api_client)
    ...
    @JsonClass(generateAdapter = true)
    internal data class  HermesParcelStatus(
