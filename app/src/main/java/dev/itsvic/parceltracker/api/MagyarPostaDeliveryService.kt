...
object MagyarPostaDeliveryService : DeliveryService {
    ...
    override suspend fun getParcel(
        ...
        val history = events.map {
            ParcelHistoryItem(
                it.tranzakcioTipusLeiras, LocalDateTime.ofInstant(
        ...
        val status = when (category) {
            ...
            "2" -> when (detailedType) {
                ...
                "31", "38", "NAV_KIADHATO_H7", "UERT18_ONLINE", "SIKERES_ONLINE_FIZ" -> Status.Customs
    ...
    private val retrofit =
        Retrofit.Builder().baseUrl("https://posta.hu/szolgaltatasok/PostaWeb/").client(api_client)
